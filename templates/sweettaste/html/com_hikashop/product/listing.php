...
if(($this->params->get('show_image') && !empty($this->element->file_path)) || ($this->params->get('show_description',!$this->module) && !empty($this->element->category_description))){ ?>
        <div id="brand-description-container" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">            
            <div id="brand-description" class="well">                
                <?php
                if($this->params->get('show_image') && !empty($this->element->file_path)){ ?>
                    <div class="row">                        
                        ...
                        if(JFile::exists($this->image->getPath($this->element->file_path,false))){ ?>                                
                            <div class="hikashop_category_description col-xs-12 col-sm-3 col-md-2 col-lg-2">
                                <img src="<?php echo $this->image->getPath($this->element->file_path); ?>" class="img-responsive img-circle center-block"/>
                            </div>                            
                        <?php
                        } ?>
                        <div class="hikashop_category_description col-xs-12 col-sm-9 col-md-10 col-lg-10">
                            <?php                                     
                                if(!empty($this->element->category_name)) echo '<h1 class="text-center">'.$this->element->category_name.'</h1>';
								if($this->params->get('show_description',!$this->module)&&!empty($this->element->category_description))echo JHTML::_('content.prepare',$this->element->category_description);
                            ?>
                        </div>
                    </div><?php                         
                } ?>
        ...
        if ((!empty($this->element->category_name)) && ($this->element->category_type == 'manufacturer')) { ?>
        	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        	   <h2>Все картины</h2>     
        	</div>
        	<?php 
