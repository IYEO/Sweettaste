...
if ($this->config->get('manufacturer_display', 0) && !empty($this->element->product_manufacturer_id)) {
    ...
    echo $this->image->display($manufacturer->file_path, false, $manufacturer->file_name, 'class="img-circle img-responsive pull-left"', '', 200, 200);
}
?>
</div>
<div class="col-xs-8 col-sm-4 col-md-4 col-lg-6">	    
    ...
    <span id="hikashop_product_name_main" class="hikashop_product_name_main">
        ...
        if (hikashop_getCID('product_id') != $this->element->product_id && isset($this->element->main->product_name))
            echo '<strong>' . $this->element->main->product_name . '</strong>';
        else
            echo '<strong>' . $this->element->product_name . '</strong>';
        ?>
    </span><br />
    <?php echo JHTML::_('content.prepare', preg_replace('#<hr *id="system-readmore" */>.*#is', '', $this->element->product_description)); ?>
...
<div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 xs-social-padding">
    <div class="row">
        <div class="col-xs-5 col-xs-push-7 col-sm-5 col-md-push-6 col-md-6 col-lg-6">
            <?php
            $form = ',0';
        ...
        <div class="col-xs-7 col-xs-pull-5 col-sm-7 col-md-pull-6 col-md-6 col-lg-6">
            <?php
...
<div id="hikashop_product_bottom_part" class="hikashop_product_bottom_part col-xs-12 col-sm-12 col-md-12 col-lg-12">
<?php
if (!empty($this->element->extraData->bottomBegin))
    echo implode("\r\n", $this->element->extraData->bottomBegin);
?>	
    <?php echo JHTML::_('content.prepare', preg_replace('#[\s\S]*<hr *id="system-readmore" */>#i', '', $this->element->product_description)); ?>	
