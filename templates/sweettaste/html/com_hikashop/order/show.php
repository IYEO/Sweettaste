...
<form action="<?php echo hikashop_completeLink('order'.$url_itemid); ?>" method="post"  name="adminForm" id="adminForm">    
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
                <div id="hikashop_order_left_part" class="hikashop_order_left_part">
                    <p><?php echo $this->store_address; ?></p>
                </div>
            </div>
    ...
    <?php
        $params = null;
        $js = '';
        $ShowShAddr = FALSE; //Show <div> with shipping address (Boolean)
        $colSM = 6;
        $colMD = 6;
        $colLG = 6;
        $HTMLRes = '';
    ...
    <?php
        if (!empty($this->element->order_shipping_id) && !empty($this->element->shipping_address)) {
            $ShowShAddr = true; ?>
            <div class="row">
                <div class="col-xs-12 col-sm-<?php echo $colSM ?> col-md-<?php echo $colMD ?> col-lg-<?php echo $colLG ?>  pull-right">
    ...
    <?php if (!empty($this->element->billing_address)) { ?>        
        <div class="col-xs-12 col-sm-<?php echo $colSM ?> col-md-<?php echo $colMD ?> col-lg-<?php echo $colLG ?> pull-left">
        ...
        <?php ($ShowShAddr) ? $HtmlRes = '</div>': $HTMLRes = ''; echo $HTMLRes;?>
    <?php
    } ?>
    <table width="100%">
            <tr>
                                ...
                                <table width="100%">
                                    <thead>
                                        ...
                                        <?php
                                            ...
                                            <tr>                                                    
                                                    <td class="hikashop_order_subtotal_title text-right" style="border-top:2px solid #B8B8B8;" class="key">
                                                            <label>
                                            ...
                                            <tr>
                                                    <td class="hikashop_order_shipping_title key text-right">
                                                            <label>
                                            ...
                                            <tr>
                                                    <td class="hikashop_order_payment_title key text-right">
                                                            <label>
                                            ...
                                            <?php } ?>
                                            <tr>
                                                    <td class="hikashop_order_total_title key text-right">
                                                            <label>
                ...
                <td>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <?php if(!empty($this->shipping)){ ?>                        
                                <?php echo "<p class=\"text-info\">".JText::_('HIKASHOP_SHIPPING_METHOD').' : ';
                        ...
                        <?php if(!empty($this->payment)){
                                echo "<p class=\"text-success\">" . JText::_('HIKASHOP_PAYMENT_METHOD').' : '.$this->payment->getName($this->order->order_payment_method,$this->order->order_payment_id) . "</p>";
                        }?>
                    </div>
                </td>
            </tr>
