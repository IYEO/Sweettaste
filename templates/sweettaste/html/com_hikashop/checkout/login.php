...
<?php
		if($display_login) {
 			if($this->registration[2]){
 				echo '<h1 class="text-center">'.JText::_('LOGIN_OR_GUEST').'</h1>';
			} else {
				echo '<h1 class="text-center">'.JText::_('LOGIN_OR_REGISTER_ACCOUNT').'</h1>';
			}
		}
?>
<div role="tabpanel">  
    <ul class="nav nav-tabs" role="tablist">
        ...
        <?php } ?>    
        <li role="presentation" <?php $display_login ? '' : 'class="active"';?>>
    ...
    <div class="tab-content">
        <?php if ($display_login) { ?>
            <div class="tab-pane fade in active" id="login" role="tabpanel">
                <div class="auth well col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">                                        
        ...
        <div role="tabpanel" class="tab-pane <?php echo $display_login ? 'fade' : 'active';?>" id="registration">
            <div class="auth well col-xs-12 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4">
                <fieldset class="input">            
                    <?php
