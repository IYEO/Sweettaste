...
CREATE TABLE IF NOT EXISTS `#__hikashop_plugin` (
	...
	PRIMARY KEY (`plugin_id`)
		...
		if(version_compare($this->fromVersion, '2.4.1', '<')) {
			$this->addColumns("order","`order_currency_info` text NOT NULL DEFAULT ''");
			$this->addColumns("taxation","`taxation_ordering` int(10) unsigned NOT NULL DEFAULT '0'");
			$this->addColumns("characteristic","`characteristic_display_method` varchar(255) NOT NULL DEFAULT ''");
		}
