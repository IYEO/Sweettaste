				...
				<fieldset class="adminform" id="htmlfieldset_products">
					...
					<table cellpadding="1" width="100%">
						...
						?>
							...
							<?php
							$taxes = round($this->order->order_subtotal-$this->order->order_subtotal_no_vat+$this->order->order_shipping_tax-$this->order->order_discount_tax,$this->currencyHelper->getRounding($this->order->order_currency_id,true));
